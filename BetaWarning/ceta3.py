...
"""     
beta10   MixSAC, BWHC, args.max_step = 2 ** 11
beta1    MixSAC, Ant,  args.max_step = 2 ** 11 norm std + 1e-2
beta11   MixSAC, Ant,  args.max_step = 2 ** 10 norm std + 1e-5

beta3    MixSAC, args.max_step = 2 ** 11
beta12   MixSAC, args.max_step = 2 ** 10
beta10   MixSAC, BWHC, args.max_step = 2 ** 11

beta0    mix buffer
beta1    mix buffer, policy
