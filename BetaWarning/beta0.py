...
beta0 OffPPO
beta3 InterOffPPO
beta2 beta3 + twin critic
beta1 beta2 same_lr

InterOffPPO (GAE)
ceta4 InterOffPPO (GAE)

ceta0 twin critic diff lr, BW
ceta1 twin critic diff lr, Minitaur
ceta2 twin critic same lr 
ceta3 twin critic same lr 
...
def fix_car_racing_v0_1111(env):  # plan todo CarRacing-v0
    ...
    def decorator_step(env_step):
        def new_env_step(action):
            ...
            env.state_stack.append(rgb2gray(state))
