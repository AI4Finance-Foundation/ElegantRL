#ifndef SETCOVER_LIB_H
#define SETCOVER_LIB_H

extern "C" int Init(const int argc, const char** argv);

extern "C" int InsertGraph(bool isTest, const int g_id, const int num_primal, const int num_dual, const int num_edges, const int* edges_from, const int* edges_to);
