...
void NewQNet::SetupGraphInput(std::vector<int>& idxes, 
...
void NewQNet::SetupTrain(std::vector<int>& idxes, 
                      std::vector< std::shared_ptr<Graph> >& g_list, 
                      std::vector< std::vector<int>* >& covered, 
...
void NewQNet::SetupPredAll(std::vector<int>& idxes, 
                        std::vector< std::shared_ptr<Graph> >& g_list, 
                        std::vector< std::vector<int>* >& covered)
{    
