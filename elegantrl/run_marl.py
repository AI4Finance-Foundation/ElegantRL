...
from elegantrl.env_marl import build_env
...
def train_and_evaluate(args, agent_id=0):
    ...
    evaluator = Evaluator(args.cwd, agent_id, True, eval_env,
                          args.eval_gap, args.eval_times1, args.eval_times2, 100000, if_overwrite =False)
