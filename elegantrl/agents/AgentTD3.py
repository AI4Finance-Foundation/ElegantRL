...
class AgentTD3(AgentBase):
    ...
    def __init__(self, net_dim: int, state_dim: int, action_dim: int, gpu_id=0, args=None):
        ...
        self.explore_noise_std = 0.1  # standard deviation of exploration noise
        self.policy_noise_std = 0.2  # standard deviation of policy noise
        self.update_freq = 2  # delay update frequency

    def update_net(self, buffer: ReplayBuffer, batch_size: int) -> tuple:
