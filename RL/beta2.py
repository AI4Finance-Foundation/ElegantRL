...
class sac_agent:
    def __init__(self, env, args):
        ...
        self.qf1 = flatten_mlp(self.env.observation_space.shape[0], self.args.hidden_size,
                               self.env.action_space.shape[0])
        self.qf2 = flatten_mlp(self.env.observation_space.shape[0], self.args.hidden_size,
                               self.env.action_space.shape[0])
        # set the target q functions
        self.target_qf1 = copy.deepcopy(self.qf1)
        self.target_qf2 = copy.deepcopy(self.qf2)
        # build up the policy network
        self.actor_net = tanh_gaussian_actor(self.env.observation_space.shape[0], self.env.action_space.shape[0],
    ...
    def learn(self):
        ...
        for epoch in range(self.args.n_epochs):
            ...
            if epoch % self.args.display_interval == 0:
                ...
                print('E&R {} {:7.2f} |QF1&2 {:7.2f} {:7.2f} |AL {:7.3f} |Alpha&L {:7.3f} {:7.3f}'.format(
