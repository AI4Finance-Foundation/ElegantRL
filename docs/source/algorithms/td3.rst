...
.. note::
    For the clipped Double-Q learning, we implement two Q-networks under a single Class with shared parameters. Such an implementation allows a lower computational and training time cost.
